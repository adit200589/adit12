...
<head>
  ...
  <!-- site metas -->
  <title>www.Perpus Indobook.com</title>
...
<body>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="banner_taital_main">
                      <h1 class="banner_taital">Selamat Datang di Perpustakaan Indobook</h1>
                      <div class="btn_main">
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-6">
          ...
          <div class="footer_menu">
            <ul>
              <p class="dummy_text">Cimatis Swadaya 04 Jatikarya jati sampurna Bekasi</p>
  ...
  <div class="copyright_section">
    <div class="container">
      <p class="copyright_text">2023 All Rights Reserved. Design by <a href="#">Perpustakaan Indobook.com</a></p>
    </div>
  </div>
